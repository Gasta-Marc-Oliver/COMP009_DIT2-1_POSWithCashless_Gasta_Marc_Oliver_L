...
public class NewJFrame extends javax.swing.JFrame {
    ...
    private javax.swing.JButton jButtonCashless;
 ...
 public void addtable(int id, String name, int qty, double price) {
   ...
   public void Bill() {
        ...
        try {
           ...
           b.setText("                         Tira Bahala Kainan \n");
            b.setText(b.getText() + "                         Blk.5 K-9 Area/ Samabana St., \n");
            b.setText(b.getText() + "                         Lower Bicutan, Taguig City, \n");
            ...
            b.setText(b.getText() + "-------------------------------------------------------------------------\n");
            b.setText(b.getText() + "                     Made with love and care"+"\n");
   ...
   // pat btn action
    ...
    private void initComponents() {
        ...
        setTitle("Simple POS System with Cashless Option");
        ...
        jPanel3.setToolTipText("Simple POS System with Cashless Option");
    ...
    private void jButtonCashlessActionPerformed(ActionEvent evt) {
        // Action performed when the button is clicked
        // Show the image in a new JFrame
        JFrame imageFrame = new JFrame();
        JLabel imageLabel = new JLabel(new ImageIcon("/pic/Untitled 1.jpg"));
    ...
    private void jButton9ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton9ActionPerformed
        ...
        addtables(7, "Frozen Goods", i, 12.99);
    ...
    private void jButton8ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton8ActionPerformed
        ...
        addtables(8, "Dairy Product  ", i, 13.99);
